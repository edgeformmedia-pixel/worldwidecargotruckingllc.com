(() => {
  ...
  let applications = [], activeDrivers = [], quotes = [], adminUsers = [], emailProfiles = [], outboundMessages = [], emailSettings = {}, currentAdmin = null, bootstrapSession = false, refreshTimer, activeView = "home", showingArchive = false, partnerTarget = null, activateTarget = null, noteTarget = null, callbackScheduleTarget = null;
  ...
  function renderDrivers() {
    const active = filteredApplications(false), archived = filteredApplications(true), groups = { phone_screen: [], docs_requested: [], docs_received: [], documents_processed: [], sold_hired_partner: [], callback_hired: [], orientation_complete: [] };

  ...
  function renderAdminUsers() {
    ...
    ui.adminUserList.replaceChildren(...adminUsers.map((user) => {
      ...
      if (user.role === "employee") {
        ...
        (user.email_profiles || []).forEach((profile) => { const chip = element("span", "email-access-chip", profile.sender_email); if (profile.is_default) chip.title = "Default personal address"; list.append(chip); });
